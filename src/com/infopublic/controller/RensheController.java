...
@Controller
@RequestMapping(value="/renshe")    
public class RensheController extends BaseController {
	...
	//展示长沙人设
			@RequestMapping(value="/rensheindex")
			public ModelAndView rensheindex() throws Exception{
				ModelAndView mv = this.getModelAndView();
				PageData pd = new PageData();
				pd = this.getPageData();
				pd.put("SYSNAME", Tools.readTxtFile(Const.SYSNAME)); // 读取系统名称
				
				mv.setViewName("renshe/rensheindex");
				mv.addObject("pd", pd);
				return mv;
			}
