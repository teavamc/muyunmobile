...
<header data-am-widget="header" class="am-header am-header-default">
      <div class="am-header-left am-header-nav">
        ...
        <h1 class="am-header-title" id="tit"></h1>
  </header>
    ...
    <input type="hidden" value="${feedtousu.isread}" id="judge">

     <div class="weui-cells" onclick="showfeed('${feedtousu.fbid}')">
      <input type="hidden" value="${feedtousu.isread}" >
          <div class="weui-cell " >
...
$(document.body).infinite().on("infinite", function() {
  ...
  loading = true;
	  $.ajax({  
					type: "POST",
					url: "<%=basePath%>feedback/showfeedmore.do",
			    	data:  "tip="+tip+"&length="+length+"&isread="+isread,
					dataType:'json',
					cache: false,
					success: function(d){
					if(d.stop=="stop"){
