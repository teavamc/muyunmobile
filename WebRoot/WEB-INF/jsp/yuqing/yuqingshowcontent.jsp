...
<div class="weui-cells weui-cells_form" style="margin-top:0px;">
    ...
    <div class="weui-cell">
        <div class="weui-cell__bd">
          <textarea class="weui-textarea"  rows="7" value="" name="content" id="content" readonly="readonly">${yuqing.content }</textarea>
...
<div ><input id="end"  type="hidden" readonly="readonly"></div>
...
$(".cojud1").attr("src","static/images/mydel.png");
	...
	//alert(yqcid);
	window.location.href="<%=basePath%>yuqing/showyqccontent?yqcid="+yqcid;
	}
	</script>
<script type="text/javascript">
function com(){ //点击评论按钮
