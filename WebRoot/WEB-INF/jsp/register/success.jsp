...
<!--             <p class="weui-msg__desc">内容详情，可根据实际需要安排，如果换行则不超过规定长度，居中展现<a href="javascript:void(0);">文字链接</a></p> -->
        ...
        <div class="weui-msg__opr-area">
            <p class="weui-btn-area">
                <a href="<%=basePath%>login_toLogin.do" class="weui-btn weui-btn_primary">点击登陆</a>
                <a href="<%=basePath%>partymember/yanzhengpartymem" class="weui-btn weui-btn_primary">绑定党员账号</a>
            </p>
        </div>
